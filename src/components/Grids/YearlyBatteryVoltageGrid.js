...
let showing = 1;
class YearlyBatteryVoltageGrid extends Component {
  ...
  constructor(props) {
    ...
    this.loadBatteryVoltageYearlyAverage = this.loadBatteryVoltageYearlyAverage.bind(this)
  ...
  async componentDidMount() {
    ...
    if (this.state.showing === 1)
      await this.loadBatteryVoltageYearlyAverage()
  ...
  async loadBatteryVoltageYearlyAverage() {

    let result = await API.loadBatteryVoltageYearlyAvg()
    console.log(result)
    if (result === null ) {
      ...
      xl={(this.props.sizes.xl>=12)?12:this.props.sizes.xl}  >
            {this.state.data ?
              ...
              this.state.data === 'ERROR' ?
                ...
                Charts.renderBatteryVoltageYearAvgBarGraph(this.state.data,this.props.sizes.height,this.props.sizes.height) :
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter((YearlyBatteryVoltageGrid)));