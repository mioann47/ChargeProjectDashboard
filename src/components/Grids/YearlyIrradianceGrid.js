...
let showing = 1;
class YearlyIrradianceGrid extends Component {
  ...
  constructor(props) {
    ...
    this.loadIrradianceYearlyAverage = this.loadIrradianceYearlyAverage.bind(this)
  ...
  async componentDidMount() {
    ...
    if (this.state.showing === 1)
      await this.loadIrradianceYearlyAverage()
  ...
  async loadIrradianceYearlyAverage() {

    let result = await API.loadIrradianceYearlyAvg()
      ...
      xl={(this.props.sizes.xl>=12)?12:this.props.sizes.xl}  >
            {this.state.data ?
              ...
              this.state.data === 'ERROR' ?
                ...
                Charts.renderIrradianceYearlyAvgBarGraph(this.state.data,this.props.sizes.height) :
  ...
  render() {
    ...
    if (this.state.showing === 1) {
      return this.renderIrradianceYearlyAvgGrid()
    }
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter((YearlyIrradianceGrid)));